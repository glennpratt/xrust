...
fn test_negative_hour() {
    ...
    println!("====> {:?}", (hours * 60i32 + minutes).wrapping_div(60));
    println!("====> {:?}", -65 / 60);
    println!("====> {:?}", ((hours * 60) + minutes) / 60);
    println!("====> {:?}", (hours * 60 + minutes) / 60);
    println!("====> {:?}", (hours * 60 + minutes) / 60 % 24);
    println!("====> {:?}", ((hours * 60 + minutes) / 60 % 24) + 24);
    println!("====> {:?}", (((hours * 60 + minutes) / 60 % 24) + 24) % 24);
